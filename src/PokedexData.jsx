...
export const pokemonList = [
  ...
  {name: ['exeggcute', 'noeunoeuf'],    types: ['grass', 'psychic']},
  {name: ['exeggutor', 'noadkoko'],     types: ['grass', 'psychic']},
  {name: ['cubone', 'osselet'],         types: ['ground']},
  {name: ['marowak', 'ossatueur'],      types: ['ground']},
  {name: ['hitmonlee', 'kicklee'],      types: ['fighting']},
  {name: ['hitmonchan', 'tygnon'],      types: ['fighting']},
  {name: ['lickitung', 'excelangue'],   types: ['normal']},
  {name: ['koffing', 'smogo'],          types: ['poison']},
  {name: ['weezing', 'smogogo'],        types: ['poison']},
  {name: ['rhyhorn', 'rhinocorne'],     types: ['ground', 'rock']},
  {name: ['rhydon', 'rhinoféros'],      types: ['ground', 'rock']},
  {name: ['chansey', 'leveinard'],      types: ['normal']},
  {name: ['tangela', 'saquedeneu'],     types: ['grass']},
  {name: ['kangaskhan', 'kangourex'],   types: ['normal']},
  {name: ['horsea', 'hypotrempe'],      types: ['water']},
  {name: ['seadra', 'hypocéan'],        types: ['water']},
  {name: ['goldeen', 'poissirène'],     types: ['water']},
  {name: ['seaking', 'poissoroy'],      types: ['water']},
  {name: ['staryu', 'stari'],           types: ['water']},
  {name: ['starmie', 'staross'],        types: ['water', 'psychic']},
  {name: ['mr. Mime', 'm. Mime'],       types: ['psychic', 'fairy']},
  {name: ['scyther', 'insécateur'],     types: ['bug', 'flying']},
  {name: ['jynx', 'lippoutou'],         types: ['ice', 'psychic']},
  {name: ['electabuzz', 'électek'],     types: ['electric']},
  {name: ['magmar', 'magmar'],          types: ['fire']},
  {name: ['pinsir', 'scarabrute'],      types: ['bug']},
  {name: ['tauros', 'tauros'],          types: ['normal']},
  {name: ['magikarp', 'magicarpe'],     types: ['water']},
  {name: ['gyarados', 'léviator'],      types: ['water', 'flying']},
  {name: ['lapras', 'loklhass'],        types: ['water', 'ice']},
  {name: ['ditto', 'métamorph'],        types: ['normal']},
  {name: ['evee', 'évoli'],             types: ['normal']},
  {name: ['vaporeon', 'aquali'],        types: ['water']},
  {name: ['jolteon', 'voltali'],        types: ['electric']},
  {name: ['flareon', 'pyroli'],         types: ['fire']},
  {name: ['porygon', 'porygon'],        types: ['normal']},
  {name: ['ominyte', 'amonita'],        types: ['rock', 'water']},
  {name: ['omastar', 'amonistar'],      types: ['rock', 'water']},
  {name: ['kabuto', 'kabuto'],          types: ['rock', 'water']},
  {name: ['kabutops', 'kabutops'],      types: ['rock', 'water']},
  {name: ['aeriodactyl', 'ptéra'],      types: ['rock', 'flying']},
  {name: ['snorlax', 'ronflex'],        types: ['normal']},
  {name: ['articuno', 'artikodin'],     types: ['water', 'flying']},
  {name: ['zapdos', 'électhor'],        types: ['electric', 'flying']},
  {name: ['moltres', 'sulfura'],        types: ['fire', 'flying']},
  {name: ['dratini', 'minidraco'],      types: ['dragon']},
  {name: ['dragonair', 'draco'],        types: ['dragon']},
  {name: ['dragonite', 'dracolosse'],   types: ['dragon', 'flying']},
  {name: ['mewtwo', 'mewtwo'],          types: ['psychic']},
  {name: ['mew', 'mew'],                types: ['psychic']},
];
